CC = cc
CFLAGS = -Wall -Wextra -Werror -I$(HOME) -fsanitize=address
...
EXECUTION = $(addprefix execution/, execution_a.c utils_a.c redirections_out_y.c redirections_in_y.c heredoc_a.c redirections_y.c execute_cmd_a.c)
